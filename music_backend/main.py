...
app.mount("/uploads/demos", StaticFiles(directory="uploads/demos"), name="uploads_demos")
app.mount("/uploads/images", StaticFiles(directory="uploads/images"), name="uploads_images")
